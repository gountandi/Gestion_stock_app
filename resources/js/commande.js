...
function creerLigne(produit,quantite) {
    ...
    return `<tr id="ligne_cmd_${nbligne}" class="bg-gray-100">
        ...
        <td class="py-3 px-6">
            <a>
                <button class="bg-blue-600 hover:bg-blue-500 text-white text-sm px-3 py-2 rounded-md" onclick="editerLigneCommande(${nbligne})">Editer</button>
            </a>>Editer</button>
            </a>
            <a>
                <button class="bg-red-600 hover:bg-red-500 text-white text-sm px-3 py-2 rounded-md" onclick="event.preventDefault();supprimerLigneCommande(${nbligne})">Supprimer</button>
            </a>
        </td>
    </tr>`
